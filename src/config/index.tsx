...
export const homePageConfig = {
  ...
  projects: [
    { 
      ...
      image: KittyChanLogo,
      id: 'kittychan',
      description: <>Serving <b style={{ fontSize: 20 }}>1000+</b> users in <b style={{ fontSize: 20 }}>15</b> Discord servers. Kitty chan is a <b>Discord bot</b>, powerful enough to moderate your Discord server</>,
      isBeta: false,
      isLive: true,
      features: [
        {
